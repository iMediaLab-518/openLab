...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-03-20 14:38:26
-- 服务器版本： 5.7.14
-- PHP Version: 5.6.25
...
(2, '林黛玉', '1楼1层101号房2号床', '高血压,糖尿病', '正常'),
(3, '罗大佑', '1楼1层101号房3号床', '高血压,糖尿病', '正常'),
(4, '老队员', '1楼1层102号房1号床', '高血压,糖尿病', '正常'),
(5, '绿豆芽', '1楼1层102号房2号床', '高血压,糖尿病', '正常'),
(6, '六单元', '1楼1层102号房3号床', '高血压,糖尿病', '正常');
...
(1, 1, 3, 196, 706, 431, 1, 300),
(2, 1, 416, 95, 706, 411, 1, 400),
(3, 1, 473, 383, 677, 241, 1, 500);
