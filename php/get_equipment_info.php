<?php 
	...
	while ($row = mysqli_fetch_array($rs)) {
		...
		//汇总输出
		$equipment_info[] = array('equipment_status' => $row['equipment_status'], 'bed_name' => $row_bed_info['bed_name'], 'room_id' => $row_bed_info['room_id'], 'building_name' => $row_building_info['building_name']);
